...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Имя', models.CharField(blank=True, max_length=50, null=True)),
                ('Фамилия', models.CharField(blank=True, max_length=50, null=True)),
                ('Логин', models.CharField(max_length=25, unique=True)),
                ('Пароль', models.CharField(max_length=25)),
